function loginEmailTemplate(username: string, loginLink: string) {
  return `
                              ...
                              <div style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                 <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                    <table id="u_content_image_1" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                       <tbody>
                                          <tr>
                                             <td class="v-container-padding-padding" style="pointer-events: none !important; overflow-wrap:break-word;word-break:break-word;padding:60px 0px 0px;font-family:'Raleway',sans-serif;" align="left">
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                   <tr>
                                                      <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                        <div style="height:20px"></div>
                                                         <img align="center" border="0" src="https://storage.googleapis.com/discover_chat/电脑场景.png" alt="login-image" title="image" style="outline: none;pointer-events: none !important; text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 74%;max-width: 444px;" width="444" class="v-src-width v-src-max-width"/>
                                                      </td>
                                                   </tr>
                                                </table>
                                             </td>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 5px;font-family:'Raleway',sans-serif;" align="left">
                                                <h1 style="margin: 0px; color: #091b57; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Playfair Display',serif; font-size: 26px; "><strong style="font-family: comic sans ms,sans-serif;">DiscoverChat Login</strong></h1>
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:5px 50px 10px;font-family:'Raleway',sans-serif;" align="left">
                                                <div style="font-family: comic sans ms,sans-serif; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                   <p style="line-height: 140%;">Hello ${username}, we have received a login attempt to your DiscoverChat account. To Verify your login, please click the button below:</p>
                                                </div>
                                             </td>
                                          </tr>
                                       </tbody>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 0px;font-family:'Raleway',sans-serif;" align="left">
                                                <div align="center">
                                                   <a href=${loginLink} target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:'Raleway',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #091b57; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                   <span style="font-family: comic sans ms,sans-serif; display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Click Here To Login</span></span>
                                                   </a>
                                                </div>
                                             </td>
                                          </tr>
                                       ...
                                       <tr>
                                          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 80px 10px;font-family:'Raleway',sans-serif;" align="left">
                                             <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                                <p style="font-size: 14px; line-height: 160%;"><span style="font-family: 'comic sans ms', sans-serif; line-height: 22.4px;">Please ignore this email if you didn't attempt to log in to DiscoverChat.</span></p>
                                             </div>
